...
int main()
{
	...
	cout<<"Ponto 1: x = "<<ponto3.x<<" y = "<<ponto3.y<<endl;
	cout<<"Ponto 2: x = "<<ponto4.x<<" y = "<<ponto4.y<<endl;
...
/* Comparar a menor distancia da faixa com a menor distancia dos lados esquerdo e direito */
